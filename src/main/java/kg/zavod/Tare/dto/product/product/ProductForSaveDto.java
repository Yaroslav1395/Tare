...
@AllArgsConstructor
@Builder
@Schema(description = "Класс необходим  для сохранения продукта")
...
public class ProductForSaveDto {
    ...
    private List<@Valid CharacteristicValueForSaveWithProductDto> characteristicsValues;
    @Schema(description = "Картинки продукта")
    @NotEmpty(message = "Продукт должен иметь хотя бы одну картинку")
    private List<@Valid ImageForSaveWithProductDto> images;
}
