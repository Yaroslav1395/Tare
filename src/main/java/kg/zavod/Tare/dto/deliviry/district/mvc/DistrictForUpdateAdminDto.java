package kg.zavod.Tare.dto.deliviry.district.mvc;
...
@AllArgsConstructor
@Builder
@Schema(description = "Класс необходим для редактирования района")
@JsonIgnoreProperties(ignoreUnknown = true)
public class DistrictForUpdateAdminDto {
    @Schema(description = "Id района")
    @NotNull(message = "Id района не может быть пустым")
    @Min(value = 1, message = "Id района не может быть меньше 1-го")
    private Integer id;
